...
class CCurrentActivitiesVC: ParentVc {
    ...
    func getPostedJobDetails() {
        ...
        let headers: HTTPHeaders = ["Authorization" : "Bearer \(accessTokenT ?? "")",
         ...
         let param: [String: Any] = ["user_id" : userIdT!]
          ...
          AF.request("http://sampleapp-env.eba-xbpbgrv3.ap-southeast-2.elasticbeanstalk.com/api/jobPosts/client/active_jobs",method:.post, parameters: param , encoding:  JSONEncoding.default, headers: headers).responseJSON {(responseData) -> Void in
...
extension CCurrentActivitiesVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblView.dequeueReusableCell(withIdentifier: "cell") as! CCurrentActivitiesTableViewCell
