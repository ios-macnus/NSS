//
//  CShortlistedJobApplicationsVC.swift
//  NSS
//
...
class CShortlistedJobApplicationsVC: ParentVc {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        getPostedJobDetails()
        NotificationCenter.default.addObserver(self,selector: #selector(self.afterShortlistReload),name: NSNotification.Name(rawValue: "afterShortlistReload"),object: nil)
       
    }
    @objc private func afterShortlistReload() {
        getPostedJobDetails()
...
extension CShortlistedJobApplicationsVC: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return tblCount
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblView.dequeueReusableCell(withIdentifier: "cell") as! CShortlistedJobTableViewCell
