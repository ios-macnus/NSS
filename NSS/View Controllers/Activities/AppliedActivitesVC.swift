...
class AppliedActivitesVC: ParentVc {
    ...
    func fetchListData() {
        ...
        viewModel.urlFetch = APIConstants.fetchUrl(.freelancer_applied_jobsApi)
...
extension AppliedActivitesVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblView.dequeueReusableCell(withIdentifier: "cell") as! AppliedActivitiesTableViewCell
