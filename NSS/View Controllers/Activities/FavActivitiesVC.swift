...
class FavActivitiesVC: ParentVc {
    ...
    func fetchListData() {
        ...
        viewModel.urlFetch = APIConstants.fetchUrl(.freelancer_favourite_jobsApi)
...
extension FavActivitiesVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblView.dequeueReusableCell(withIdentifier: "cell") as! FavActivitiesTableViewCell
