...
class ClientProfileReviewsVC: ParentVc {
...
extension ClientProfileReviewsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tblView.dequeueReusableCell(withIdentifier: "cell") as! ClientProfileReviewsTableViewCell
