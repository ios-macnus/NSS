...
open class DropDown : UITextField{
    ...
    @IBInspectable public var rowHeight: CGFloat = 15
    ...
    @IBInspectable public var borderColorT: UIColor =  UIColor.lightGray {
        didSet {
            layer.borderColor = borderColorT.cgColor
        }
    }
    ...
    fileprivate  var dataIDArray = [Int]()
    ...
    public var optionIds = [Int]() {
        didSet{
            self.dataIDArray = self.optionIds
        }
    }
    ...
    public func showList() {
        ...
        table.delegate = self
        table.alpha = 0
        table.separatorStyle = .none//.singleLineEtched
...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell!.accessoryType = (indexPath.row == selectedIndex) && checkMarkEnabled  ? .none : .none
        cell!.selectionStyle = .none
        cell?.textLabel?.font = self.font!.withSize(13)
...
extension DropDown: UITableViewDelegate {
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let selectedID = self.dataIDArray[self.selectedIndex!]
        ...
        if let selected = optionArray.index(where: {$0 == selectedText}) {
            didSelectCompletion(selectedText, selected , selectedID )
        }
